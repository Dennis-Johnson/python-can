...
class GeneralPurposeUdpMulticastBus:
    ...
    def _create_socket(self, address_family: socket.AddressFamily) -> socket.socket:
        ...
        try:
            ...
            # if receive_own_messages : raise NotImplementedError
            # enable_loop = 1 is receive_own_messages else 0
            # sock.setsockopt(socket.IPPROTO_IPV6, socket.IPV6_MULTICAST_LOOP, 0) for ipv6. 
